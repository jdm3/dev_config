...
""hi lCursor
hi MatchParen			guifg=#70e370	guibg=#233323	gui=bold
...
hi Special				guifg=#e3e3ab	guibg=bg		gui=italic,underline
...
hi SpecialChar			guifg=#ac7373	guibg=bg		gui=none
...
hi Function 			guifg=#efefbc	guibg=bg		gui=none
...
"	hi Structure		guifg=#ddaa77	guibg=#343434	gui=none
...
hi Todo			guifg=#dddd00	guibg=bg	gui=italic,bold,underline
